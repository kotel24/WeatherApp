package ru.sumin.weatherapp.data.local.db
...
import ru.sumin.weatherapp.data.local.model.CityDbModel
...
interface FavouriteCitiesDao {
    ...
    @Query("SELECT * FROM favourite_cities WHERE id=:cityId LIMIT 1")
